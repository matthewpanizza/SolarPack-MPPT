//*****************************************************************************
//
// TIDFUprot.h : Private header file containing definitions of Luminary-
...
#ifndef __TIDFUPROT_H__
#define __TIDFUPROT_H__
...
// wLength       - sizeof(tTIDFUQueryTIProtocol)
//
//*****************************************************************************
...
#define LM_DFU_PROTOCOL_VERSION_1 0x2001

#ifndef DEPRECATED
//
// Deprecated definitions included for backwards compatibility
//
#define USBD_DFU_REQUEST_LUMINARY USBD_DFU_REQUEST_TI
#define REQUEST_LUMINARY_VALUE REQUEST_TI_VALUE
#endif
...
//
//*****************************************************************************
#define TI_INFO_VER_M       0x70000000  // ClassInfo version mask
#define TI_INFO_VER_SHIFT   28
#define TI_INFO_VER_0       0x00000000  // ClassInfo version 0
#define TI_INFO_VER_1       0x10000000  // ClassInfo version 1
#define TI_INFO_CLASS_M     0x00FF0000  // TI Device Class
#define TI_INFO_CLASS_SHIFT 16
#define TI_INFO_CLASS_DUSTDEVIL \
                                0x00030000    // DustDevil-class Device
#define TI_INFO_CLASS_TEMPEST   \
                                0x00040000    // Tempest-class Device
#define TI_INFO_MAJ_M       0x0000FF00  // Major revision mask
#define TI_INFO_MAJ_SHIFT   8
#define TI_INFO_MIN_M       0x000000FF  // Minor revision mask
#define TI_INFO_MIN_SHIFT   0

#define TI_PART_M           0x00FF0000
#define TI_PART_SHIFT       16

#define TI_ERASE_ALL   1
#define TI_ERASE_BLOCK 0

#ifndef DEPRECATED
//
// Deprecated definitions included for backwards compatibility
//
#define LUMINARY_INFO_VER_M             TI_INFO_VER_M
#define LUMINARY_INFO_VER_SHIFT         TI_INFO_VER_SHIFT
#define LUMINARY_INFO_VER_0             TI_INFO_VER_0
#define LUMINARY_INFO_VER_1             TI_INFO_VER_1
#define LUMINARY_INFO_CLASS_M           TI_INFO_CLASS_M
#define LUMINARY_INFO_CLASS_SHIFT       TI_INFO_CLASS_SHIFT
#define LUMINARY_INFO_CLASS_DUSTDEVIL   TI_INFO_CLASS_DUSTDEVIL
#define LUMINARY_INFO_MAJ_M             TI_INFO_MAJ_M
#define LUMINARY_INFO_MAJ_SHIFT         TI_INFO_MAJ_SHIFT
#define LUMINARY_INFO_MIN_M             TI_INFO_MIN_M
#define LUMINARY_INFO_MIN_SHIFT         TI_INFO_MIN_SHIFT

#define LUMINARY_PART_M                 TI_PART_M
#define LUMINARY_PART_SHIFT             TI_PART_SHIFT

#define LUMINARY_ERASE_ALL              TI_ERASE_ALL
#define LUMINARY_ERASE_BLOCK            TI_ERASE_BLOCK
#endif

//*****************************************************************************
//
// TI-specific command identifiers.  These are passed to the device
// in standard DFU download requests.
//
//*****************************************************************************
#define TI_CMD_PROG  0x01
#define TI_CMD_READ  0x02
#define TI_CMD_CHECK 0x03
#define TI_CMD_ERASE 0x04
#define TI_CMD_INFO  0x05
#define TI_CMD_BIN   0x06
#define TI_CMD_RESET 0x07

#ifndef DEPRECATED
//
// Deprecated definitions included for backwards compatibility
//
#define LUMINARY_CMD_PROG   TI_CMD_PROG
#define LUMINARY_CMD_READ   TI_CMD_READ
#define LUMINARY_CMD_CHECK  TI_CMD_CHECK
#define LUMINARY_CMD_ERASE  TI_CMD_ERASE
#define LUMINARY_CMD_INFO   TI_CMD_INFO
#define LUMINARY_CMD_BIN    TI_CMD_BIN
#define LUMINARY_CMD_RESET  TI_CMD_RESET
#endif
...
//
#define tDFUQueryLuminaryProtocol tDFUQueryTIProtocol
#endif
...
#define TI_CMD_LEN (sizeof(tDFUDownloadHeader))

#ifndef DEPRECATED
//
// Deprecated definition included for backwards compatibility
//
#define LUMINARY_CMD_LEN TI_CMD_LEN
#endif

//*****************************************************************************
//
// Header for the TI_CMD_PROG command.
//
...
// aborted.
//
// By using this protocol, the TI_CMD_PROG command header may be used as
// a simple header on the binary files to be sent to the DFU device for
// programming.  If we enforce the requirement that the TI_CMD_PROG
...
typedef struct
{
    unsigned char  ucCommand;   // TI_CMD_PROG
...
//****************************************************************************
//
// Header for the TI_CMD_READ and TI_CMD_CHECK commands.
//
// The TI_CMD_READ command may be used to set the address range whose
...
// USBD_DFU_REQUEST_DNLOAD with ucCommand TI_CMD_READ, usStartAddr set
...
//
// To check that a region of flash is erased, the TI_CMD_CHECK command
...
typedef struct
{
    unsigned char  ucCommand;    // TI_CMD_READ or TI_CMD_CHECK
...
//****************************************************************************
//
// Header for the TI_CMD_ERASE command.
//
...
// size of the device may be determined using the TI_CMD_INFO command.
//
//*****************************************************************************
typedef struct
{
    unsigned char  ucCommand;      // TI_CMD_ERASE
...
//****************************************************************************
//
// Header for the TI_CMD_INFO command.
//
...
typedef struct
{
    unsigned char ucCommand;     // TI_CMD_INFO
...
//****************************************************************************
//
// Header for the TI_CMD_BIN command.
//
// This command may be used to tell the device whether or not to include the
// TI_CMD_PROG header before downloaded data.  By default, this is the
...
typedef struct
{
    unsigned char ucCommand;     // TI_CMD_BIN
...
//*****************************************************************************
//
// Payload returned in response to the TI_CMD_INFO command.
//
// This is structure is returned in response to the first
// USBD_DFU_REQUEST_UPLOAD request following a TI_CMD_INFO command.
//
//*****************************************************************************
typedef struct
{
