...
ShowHelp(void)
{
    ...
    printf("existing application image store it either as raw data or\n");
    printf("wrapped as a DFU-downloadable image.\n\n");
    ...
    printf("-c        - Clears the entire writable area of flash. Trumps -u.\n");
    printf("-f <file> - The file name for upload or download use. Files to be \n");
	printf("            downloaded must be in the hex image file format.\n");
