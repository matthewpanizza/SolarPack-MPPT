...
//!
//!  Channels ePWM1A and ePWM2A will have fine edge movement due to the HRPWM logic when the duty cycle is altered.
...
// i.e.: #define PWM_CH 5   // Configured for 4 HRPWM channels, but F2806x has a maximum of 7 HRPWM channels (8=7+1)
