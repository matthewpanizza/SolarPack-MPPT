...
#define TI_FEATURE_CSM_CONTROL               0x00000002
...
typedef struct
{
    ...
    tLong          ulLength;    // Total length, in bytes, of following data
...
typedef struct
{
    ...
    tShort         usStartAddr;  // Block start address / 1024
    tLong          ulLength;     // The number of bytes of data to read back or
                                 // check.
}
...
typedef struct
{
    ...
    //
    //! Information on the part class and revision as read from the CLASSID register.
    //
    tLong ulClassInfo;
